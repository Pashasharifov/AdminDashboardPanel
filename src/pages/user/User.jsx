...
function User(){
   const [a,setA]=useState([])
    ...
    useEffect(()=>{
        ...
        console.log(a)
        console.log(b) 
        axios.get('http://localhost/api/placeHolder.php?id='+b[4]).then(response=>
        {
            setA(response.data)
            console.log(a)
                ...
                <div className="userContainer">
                    <div className="userShow">
                        <div className="userShowTop">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSji8K7Ic2jUu2wYVpqJuu41FWulRufrvPZ4A&usqp=CAU" alt="" className="userShowImg" />
                        ...
                        <div className="userShowBottom">
                            ...
                            <div className="userShowInfo"> 
                             <PermIdentityIcon className="userShowIcon"/>
                              <span className="userShowInfoTitle">annabeck96</span>
                            </div>
                            ...
                            <div className="userShowInfo"> 
                             <LocationSearchingIcon className="userShowIcon"/>
                              <span className="userShowInfoTitle">Baku | Azerbaijan</span>
                            </div>
                    ...
                    <div className="userUpdate">
                        ...
                        <form  className="userUpdateForm" onSubmit={(e)=>{
                            e.preventDefault()
                                   
                                   var a=window.location.href
                                   var b=a.split('/')
                                   axios.get('http://localhost/api/update.php', {
                      params: {
